...
namespace BattleBuff
{
    ...
    public abstract class CountDownBuff : Buff
    {
        ...
        public CountDownBuff(string buffID, int maxCount, CountDownTriggerType triggerType, BuffTag buffTag = BuffTag.None, BuffTag buffImmuneTag = BuffTag.None)
        {
            this.buffTypeID = buffID;
            this.buffTag = buffTag;
            this.buffImmuneTag = buffImmuneTag;
    ...
    public class CountDownAddBuff : CountDownBuff
    {
        ...
        public CountDownAddBuff(string buffID, int maxCount, string additionBuffID, CountDownTriggerType triggerType, BuffTag buffTag = BuffTag.None, BuffTag buffImmuneTag = BuffTag.None)
            : base(buffID, maxCount, triggerType, buffTag, buffImmuneTag)
        {
